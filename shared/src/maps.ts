...
export const MAPS: MapConfig[] = [
  {
    ...
    distance: 4000,
    checkpoints: generateHighwayCheckpoints(16, 4000, 3),
  ...
  },
  {
    ...
    distance: 3500,
    checkpoints: generateHighwayCheckpoints(14, 3500, 2),
  ...
  },
  {
    ...
    distance: 4000,
    checkpoints: generateHighwayCheckpoints(16, 4000, 2.5),
  ...
  },
  {
    id: 'mumbai_pune',
    name: 'Mumbai → Pune',
    description: 'Mumbai-Pune Expressway through Western Ghats',
    distance: 3500,
    checkpoints: generateHighwayCheckpoints(12, 3500, 4),
    scenery: generateScenery('flyover', 50, 30),
    roadType: 'highway',
    signs: defaultSigns(),
    trafficDensity: 0.7,
  ...
  },
  {
    id: 'delhi_jaipur',
    name: 'Delhi → Jaipur',
    description: 'NH48 through Rajasthan desert plains',
    distance: 3500,
    checkpoints: generateHighwayCheckpoints(14, 3500, 1.5),
    scenery: generateScenery('hotel', 55, 45),
    roadType: 'highway',
    signs: defaultSigns(),
    trafficDensity: 0.45,
    weatherPool: ['clear', 'wind', 'fog'],
    defaultTimeOfDay: 'afternoon',
    isCircuit: false,
    laps: 1,
  },
  {
    ...
    description: 'State highway through Karnataka cities',
    distance: 3000,
    checkpoints: generateHighwayCheckpoints(12, 3000, 3),
    scenery: generateScenery('college', 65, 30),
    roadType: 'city',
    signs: defaultSigns(),
    trafficDensity: 0.8,
  ...
  {
    id: 'kerala_hills',
    name: 'Kerala Hill Roads',
    description: 'Winding mountain roads through Western Ghats tea estates',
    distance: 2500,
    checkpoints: generateHighwayCheckpoints(18, 2500, 8),
    scenery: generateScenery('tree', 90, 20),
    roadType: 'hill',
    signs: defaultSigns(),
    trafficDensity: 0.3,
    weatherPool: ['fog', 'rain', 'clear'],
    defaultTimeOfDay: 'sunrise',
    isCircuit: false,
    laps: 1,
  },
  {
    ...
    description: 'High altitude roads through Himalayan passes',
    distance: 3000,
    checkpoints: generateHighwayCheckpoints(16, 3000, 6),
    scenery: generateScenery('temple', 40, 50),
    roadType: 'hill',
    signs: defaultSigns(),
    trafficDensity: 0.15,
    weatherPool: ['clear', 'wind', 'fog'],
  ...
  {
    id: 'goa_beach',
    name: 'Goa Beach Roads',
    description: 'Coastal roads along Arabian Sea beaches',
    distance: 2000,
    checkpoints: generateHighwayCheckpoints(10, 2000, 5),
    scenery: generateScenery('hotel', 45, 25),
    roadType: 'beach',
    signs: defaultSigns(),
    trafficDensity: 0.4,
    weatherPool: ['clear', 'wind', 'rain'],
  ...
  },
  {
    id: 'village_roads',
    name: 'Village Roads',
    description: 'Rural roads through Indian villages with farms and cattle',
    distance: 1800,
    checkpoints: generateHighwayCheckpoints(10, 1800, 4),
    scenery: [...generateScenery('house', 30, 15), ...generateScenery('cow', 20, 10)],
    roadType: 'village',
    signs: defaultSigns(),
    trafficDensity: 0.2,
    weatherPool: ['clear', 'rain', 'thunder'],
  ...
  },
  {
    id: 'city_roads',
    name: 'City Roads',
    description: 'Dense urban traffic through Indian metro cities',
    distance: 1500,
    checkpoints: generateHighwayCheckpoints(12, 1500, 10),
    scenery: generateScenery('metro_pillar', 100, 15),
    roadType: 'city',
    signs: defaultSigns(),
    trafficDensity: 0.95,
    weatherPool: ['clear', 'rain', 'fog'],
  ...
  },
  {
    ...
    description: 'Closed circuit highway loop for lap racing',
    distance: 2000,
    checkpoints: generateHighwayCheckpoints(12, 2000, 6),
    scenery: generateScenery('toll_gate', 40, 30),
    roadType: 'circuit',
    signs: defaultSigns(),
    trafficDensity: 0.5,
    weatherPool: ['clear', 'rain', 'wind', 'fog'],
    defaultTimeOfDay: 'afternoon',
    isCircuit: true,
    laps: 3,
  },
...
export const ACHIEVEMENTS = [
  ...
  { id: 'explorer', name: 'Explorer', description: 'Race on all 12 maps', icon: '🗺️', requirement: 12, category: 'distance' as const },
